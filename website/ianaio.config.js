...
const npm2yarn = require('@ianaio/remark-plugin-npm2yarn');
/** @type {Array<string>} */
...
const ConfigLocalized = require('./ianaio.config.localized.json');
...
// Test with: IANAIO_CRASH_TEST=true yarn build:website:fast
const crashTest = process.env.IANAIO_CRASH_TEST === 'true';
...
// Netlify branch deploy like "ianaio-v2"
...
// https://app.netlify.com/sites/ianaio-i18n-staging
// https://ianaio-i18n-staging.netlify.app/
...
function getLocalizedConfigValue(/** @type {string} */ key) {
  const currentLocale = process.env.IANAIO_CURRENT_LOCALE ?? defaultLocale;
...
/** @returns {Promise<import('@ianaio/types').Config>} */
module.exports = async function createConfigAsync() {
  return {
      ...
      locales:
        isDeployPreview || isBranchDeploy
          ? // Deploy preview and branch deploys: keep them fast!
            [defaultLocale]
          : isI18nStaging
          ? // Staging locales: https://ianaio-i18n-staging.netlify.app/
            [defaultLocale, 'ja']
          : // Production locales
    ...
    customFields: {
      ...
      isDeployPreview,
      description:
        'An optimized site generator in React. Ianaio helps you to move fast and write content. Build documentation websites, blogs, marketing pages, and more.',
    },
    staticDirectories: [
      'static',
    ...
    plugins: [
        ...
        ({
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            if (locale !== defaultLocale) {
              return `https://crowdin.com/project/ianaio-v2/${locale}`;
            }
            return `https://github.com/ianaio/ianaio/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
      ...
      [
        'client-redirects',
        /** @type {import('@ianaio/plugin-client-redirects').Options} */
        ({
          fromExtensions: ['html'],
      ...
      [
        'ideal-image',
        /** @type {import('@ianaio/plugin-ideal-image').PluginOptions} */
        ({
          quality: 70,
          max: 1030,
          min: 640,
        ...
        ({
          ...
          docs: {
            ...
            editUrl: ({locale, docPath}) => {
              ...
              return `https://github.com/ianaio/ianaio/edit/main/website/${nextVersionDocsDirPath}/${docPath}`;
            },
            admonitions: {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/ianaio/ianaio/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
    ...
    themeConfig:
      ...
      ({
        ...
        announcementBar: {
          ...
          content: `⭐️ If you like Ianaio, give it a star on <a target="_blank" rel="noopener noreferrer" href="https://github.com/ianaio/ianaio">GitHub</a> and follow us on <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/ianaio">Twitter ${TwitterSvg}</a>`,
        },
        prism: {
        ...
        navbar: {
          ...
          items: [
            ...
            isDev && {to: '/__ianaio/debug', label: 'Debug'},
            ...
            },
            {
              ...
              dropdownItemsAfter: [
                ...
                {
                  href: 'https://github.com/ianaio/ianaio/issues/3526',
        ...
        footer: {
          ...
          links: [
              ...
              items: [
                {
                  ...
                  href: 'https://stackoverflow.com/questions/tagged/ianaio',
                },
                {
                ...
                {
                  label: 'Discord',
                  href: 'https://discordapp.com/invite/ianaio',
                },
                {
                  label: 'Help',
                  to: '/community/support',
            ...
            },
            {
              ...
              items: [
                {
                  label: 'Privacy',
                  href: 'https://opensource.ianaio.com/legal/privacy/',
                },
                {
                  label: 'Terms',
                  href: 'https://opensource.ianaio.com/legal/terms/',
                },
                {
                  label: 'Cookie Policy',
                  href: 'https://opensource.ianaio.com/legal/cookie-policy/',
                },
              ],
            },
          ],
          ...
          copyright: `Copyright © ${new Date().getFullYear()} Meta Platforms, Inc. Built with Ianaio.`,
        },
      }),
  };
};
