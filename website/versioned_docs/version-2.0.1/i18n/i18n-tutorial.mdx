  ...
  return (
    <Layout>
      ...
      <main>
        ...
        <Link to="https://iana.io/blog">blog</Link>
        {/* highlight-end */}
        <img
          src="/img/home.png"
          // highlight-next-line
...
- [`https://iana.io`](https://iana.io)
- [`https://iana.io/fr`](https://iana.io/fr)
...
- Deploy your site as `fr.iana.io`
- Configure a CDN to serve it from `iana.io/fr`
