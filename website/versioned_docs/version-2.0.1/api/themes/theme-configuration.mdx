...
Ianaio uses [Prism React Renderer](https://github.com/FormidableLabs/prism-react-renderer) to highlight code blocks. All configuration are in the `prism` object.
...
- **Base path**: `website/i18n/[locale]/ianaio-theme-[themeName]`
...
```bash
website/i18n/[locale]/ianaio-theme-classic
│
