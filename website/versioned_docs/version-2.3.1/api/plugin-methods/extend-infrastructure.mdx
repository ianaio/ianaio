...
Ianaio has some infrastructure like hot reloading, CLI, and swizzling, that can be extended by external plugins.
...
Register an extra command to enhance the CLI of Ianaio. `cli` is a [commander](https://www.npmjs.com/package/commander/v/5.1.0) object.
