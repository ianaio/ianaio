...
Congratulations! You have understood most core features of Ianaio now. You have:
...
- Understood how [browser support](../browser-support.mdx) and [SEO](../seo.mdx) are done through standard Ianaio APIs
...
At this point, you probably have a big `ianaio.config.js` already😄 However, you haven't written much code yet! Most of the features are implemented through calling encapsulated Ianaio APIs. As you continue your journey, you can take three paths:

- Learn more advanced Ianaio concepts. This will help you gain a deeper understand of what the APIs do.
- Read about [all existing APIs](../ianaio-core.mdx). Many of them have not been covered in the Guides!
