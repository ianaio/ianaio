...
- [`https://v1.iana.io/docs/en/installation`](https://v1.iana.io/docs/en/installation)
- [`https://v1.iana.io/docs/en/installation.html`](https://v1.iana.io/docs/en/installation.html)

If [`cleanUrl`](https://v1.iana.io/docs/en/site-config#cleanurl-boolean) was:
