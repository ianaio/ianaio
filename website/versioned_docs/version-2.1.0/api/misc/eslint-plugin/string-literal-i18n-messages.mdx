---
slug: /api/misc/@ianaio/eslint-plugin/string-literal-i18n-messages
---
...
translate({message: 'The logo of site {siteName}'}, {siteName: 'Ianaio'})
```
...
- https://ianaio.io/docs/ianaio-core#translate
- https://ianaio.io/docs/ianaio-core#translate-imperative
