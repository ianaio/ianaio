---
sidebar_position: 10
slug: /api/plugins/@ianaio/plugin-sitemap
---
...
```bash npm2yarn
npm install --save @ianaio/plugin-sitemap
```
...
- [`noIndex`](../ianaio.config.js.mdx#noIndex): results in no sitemap generated
- [`trailingSlash`](../ianaio.config.js.mdx#trailingSlash): determines if the URLs in the sitemap have trailing slashes
...
// Plugin Options: @ianaio/plugin-sitemap
