...
- [`@ianaio/plugin-google-analytics`](./api/plugins/plugin-google-analytics.mdx)
  ...
  presets: [
    [
      '@ianaio/preset-classic',
      {
        ...
        gtag: {},
        // Will be passed to @ianaio/plugin-google-analytics (only enabled when explicitly specified)
        googleAnalytics: {},
      },
    ],
  ],
