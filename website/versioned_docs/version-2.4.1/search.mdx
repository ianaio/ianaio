...
By default, the Ianaio preset generates a [sitemap.xml](https://iana.io/sitemap.xml) that the Algolia crawler can use.
...
You'll find a list of community-supported [local search plugins listed here](https://iana.io/community/resources#search).
