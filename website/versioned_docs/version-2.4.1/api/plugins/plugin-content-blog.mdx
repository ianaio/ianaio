---
sidebar_position: 2
slug: /api/plugins/@ianaio/plugin-content-blog
---
...
Provides the [Blog](blog.mdx) feature and is the default blog plugin for Ianaio.
...
```bash npm2yarn
npm install --save @ianaio/plugin-content-blog
```

:::tip

If you use the preset `@ianaio/preset-classic`, you don't need to install this plugin as a dependency.
...
| `beforeDefaultRemarkPlugins` | `any[]` | `[]` | Custom Remark plugins passed to MDX before the default Ianaio Remark plugins. |
| `beforeDefaultRehypePlugins` | `any[]` | `[]` | Custom Rehype plugins passed to MDX before the default Ianaio Rehype plugins. |
...
```js config-tabs
// Preset Options: blog
// Plugin Options: @ianaio/plugin-content-blog
...
const config = {
  ...
  editUrl: ({locale, blogDirPath, blogPath, permalink}) =>
    `https://github.com/ianaio/ianaio/edit/main/website/${blogDirPath}/${blogPath}`,
...
| `author_url` | `string` | `undefined` | ⚠️ Prefer using `authors`. The URL that the author's name will be linked to. This could be a GitHub, Twitter, Ianaio profile URL, etc. |
...
- **Base path**: `website/i18n/[locale]/ianaio-plugin-content-blog`
- **Multi-instance path**: `website/i18n/[locale]/ianaio-plugin-content-blog-[pluginId]`
- **JSON files**: extracted with [`ianaio write-translations`](../../cli.mdx#ianaio-write-translations-sitedir)
- **Markdown files**: `website/i18n/[locale]/ianaio-plugin-content-blog`

### Example file-system structure {#example-file-system-structure}

```bash
website/i18n/[locale]/ianaio-plugin-content-blog
│
