---
sidebar_position: 7
slug: /api/plugins/@ianaio/plugin-google-gtag
---
...
```bash npm2yarn
npm install --save @ianaio/plugin-google-gtag
```
...
```js config-tabs
// Preset Options: gtag
// Plugin Options: @ianaio/plugin-google-gtag
