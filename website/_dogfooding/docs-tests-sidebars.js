...
/**
 * @typedef {import('@ianaio/plugin-content-docs').SidebarsConfig} SidebarsConfig
 * @typedef {import('@ianaio/plugin-content-docs/lib/sidebars/types').SidebarItemConfig} SidebarItemConfig
 */
...
const sidebars = {
  sidebar: [
    ...
    <img style="width: 100px; height: 100px; display: block;" src="/img/ianaio.png" alt="Ianaio Logo" />
  `,
        },
      ],
    },
