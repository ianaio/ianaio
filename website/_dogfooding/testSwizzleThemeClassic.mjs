...
import classicTheme from '@ianaio/theme-classic';

// Unsafe imports
import {
  readComponentNames,
  getMissingIntermediateComponentFolderNames,
} from '@ianaio/core/lib/commands/swizzle/components.js';
import {normalizeSwizzleConfig} from '@ianaio/core/lib/commands/swizzle/config.js';
import {wrap, eject} from '@ianaio/core/lib/commands/swizzle/actions.js';
