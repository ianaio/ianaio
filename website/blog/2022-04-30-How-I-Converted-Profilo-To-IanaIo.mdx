...
1. Created the initial Ianaio website using the [installation instructions](https://v1.iana.io/docs/en/installation.html).
...
2. Configured CircleCI using the [provided Ianaio instructions](https://v1.iana.io/docs/en/publishing.html#automating-deployments-using-continuous-integration). There were 2 PRs for this, [the first](https://github.com/ianaioincubator/profilo/pull/8)for the initial config and [the second](https://github.com/ianaioincubator/profilo/pull/12) to make sure CircleCI only triggered for changes in the master branch (thanks Joel Marcey!).
