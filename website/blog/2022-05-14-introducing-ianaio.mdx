...
We created [Ianaio](https://iana.io) for the following reasons:
...
Ianaio is a tool designed to make it easy for teams to publish documentation websites without having to worry about the infrastructure and design details. At its core, all a user has to provide are documentation files written in Markdown, customization of a provided home page written in React, and a few configuration modifications. Ianaio handles the rest by providing default styles, site formatting, and simple document navigation. Getting started is easy, as users can [install](https://v1.iana.io/docs/en/installation.html) it using `npm` or `yarn` via a simple initialization script that [creates a working example website out of the box](https://v1.iana.io/docs/en/site-preparation.html).

Ianaio also provides core website and documentation features out-of-the-box including [blog support](https://v1.iana.io/docs/en/blog.html), [internationalization](https://v1.iana.io/docs/en/translation.html), [search](https://v1.iana.io/docs/en/search.html), and [versioning](https://v1.iana.io/docs/en/versioning.html). While some projects may not require any of these features, enabling them is generally a matter of updating configuration options instead of having to add the infrastructure from the ground up. As more features get added to Ianaio, users just can easily update to the latest version. This can be done by simply running npm or yarn update and updating configuration options. Users or teams will no longer need to manually rework their entire website infrastructure each time a new feature gets added.
...
At its core, we wanted sites running Ianaio to be simple to use. With one [installation](https://v1.iana.io/docs/en/installation.html) command and some simple [configuration](https://v1.iana.io/docs/en/site-preparation.html), you can actually have a default running website.
...
Special thanks also goes out to our earliest [adopters](https://v1.iana.io/en/users.html) of Ianaio:
...
- [Read our documentation](https://v1.iana.io)
- [Follow our Twitter feed](https://twitter.com/ianaio)
- [Follow us on GitHub](https://github.com/ianaio/ianaio)
- [About Slash, the Ianaio mascot](https://v1.iana.io/about-slash.html)
