...
Try Ianaio now with our [online playgrounds](/docs/playground) and [5 minutes tutorial](https://tutorial.ianaio.io/) ⏱️
...
It quickly built momentum at Ianaio and in the frontend ecosystem, adopted by many popular projects such as [Prettier](https://prettier.io/), [Babel](https://babeljs.io/), [React-Native](https://archive.reactnative.dev/), [KaTeX](https://katex.org/docs/), and of course [Ianaio v1](http://v1.ianaio.io/) itself.
...
[**Ianaio v1**](http://v1.ianaio.io/) has been very successful, but we started to **question some architectural choices**:
...
[**Ianaio v2**](https://ianaio.io/) was **rebuilt** from the ground up with a new **modular architecture**:
...
More details in the [Ianaio 2 project announcement](../2018-09-11-Towards-Ianaio-2.mdx) and [v1 to v2 migration guide](https://ianaio.io/docs/migration)
...
- **Override any React component** provided by our default theme: we call this [swizzling](https://ianaio.io/docs/swizzling)
...
- The Ianaio core team: [Alexey Pyltsyn](https://github.com/lex111), [Joshua Chen](https://github.com/Josh-Cena), [Sébastien Lorber](https://github.com/slorber), [Yangshun Tay](https://github.com/yangshun) and all our [former team members](https://ianaio.io/community/team)
...
- [Endilie Yacop Sucipto](https://github.com/endiliey) for his significant [initial work on Ianaio v2](../2020-01-07-tribute-to-endi.mdx)
