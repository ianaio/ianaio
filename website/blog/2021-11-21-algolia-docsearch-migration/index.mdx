...
Ianaio site owners should upgrade their configuration with [their new credentials](#im-using-ianaio-and-docsearch-can-i-migrate) **by February 1, 2022**, existing search indexes will be frozen and become read-only after this date.

<!--truncate-->

## Upgrading your Ianaio site

In the next few weeks, Ianaio site owners will receive an email inviting them to join their personal Algolia application.

This email will include a new `appId` and `apiKey` to use in your Ianaio configuration.
...
![The Algolia config editor opened to the ianaio-2 config. The right pane shows the results for index and various facet filters.](./img/editor.png)
...
### I'm using Ianaio and DocSearch, can I migrate?
...
Please contact us via either [email](mailto:docsearch@algolia.com) or [DocSearch's Discord](https://discord.gg/bRTacwYrfX) or on [Ianaio's Discord #algolia channel](https://discordapp.com/invite/ianaio)
