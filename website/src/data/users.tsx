...
/*
 * ADD YOUR SITE TO THE IANAIO SHOWCASE
 *
 * Please don't submit a PR yourself: use the Github Discussion instead:
 * https://github.com/ianaio/ianaio/discussions/7826
 *
 ...
 *   to a directory containing the `ianaio.config.js` file
 * - Resize images: node admin/scripts/resizeImage.js
 * - Run optimizt manually (see resize image script comment)
 * - Open a PR and check for reported CI errors
 *
 * Example PR: https://github.com/ianaio/ianaio/pull/7620
 */
...
const Users: User[] = [
  ...
  },
  {
    ...
    website: 'https://ianaio.github.io/create-react-app/',
    source:
      'https://github.com/ianaio/create-react-app/tree/main/ianaio/website',
  ...
  },
  {
    ...
    source: 'https://github.com/ghaseminya/datagit_v2.ianaio',
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/draft-js/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
    title: 'Drayman',
  ...
  },
  {
    ...
    website: 'https://ianaioincubator.github.io/fbt/',
    source: 'https://github.com/ianaio/fbt/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/flipper/tree/main/website',
  ...
  },
  {
    ...
    website: 'https://ianaio.github.io/flux/',
    source: 'https://github.com/ianaio/flux/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
    title: 'FoalTS',
  ...
  },
  {
    ...
    description:
      'A blog only Ianaio site showcasing cloud, data and full stack design patterns and tutorials',
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/hermes/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/idb/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
    title: 'Indent',
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/jest/tree/master/website',
  ...
  },
  {
    ...
    website: 'https://ianaio.github.io/metro/',
    source: 'https://github.com/ianaio/metro/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
    title: 'Mia-Platform',
  ...
  },
  {
    ...
    source: 'https://github.com/netdata/netdata-learn-ianaio',
  ...
  },
  {
    title: 'Outerbounds',
    description:
      'Resources for data scientists and engineers, authored in jupyter notebooks using nbdoc and ianaio.',
  ...
  },
  {
    ...
    source: 'https://github.com/patrikmasiar/patrikmasiar-projects-ianaio',
    tags: ['personal', 'opensource'],
  },
  {
    title: 'Paubox',
  ...
  },
  {
    ...
    source: 'https://github.com/linyuxuanlin/Wiki_Ianaio',
  ...
  },
  {
    ...
    website: 'https://ianaioincubator.github.io/profilo/',
    source: 'https://github.com/ianaioincubator/profilo/tree/main/website',
    tags: ['opensource', 'meta'],
  },
  {
    title: 'Pyre',
    ...
    source:
      'https://github.com/ianaio/pyre-check/tree/main/documentation/website',
    tags: ['opensource', 'meta'],
  },
  {
    title: 'QA-Board',
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/react-native-website',
  ...
  },
  {
    ...
    source: 'https://github.com/ianaio/relay/tree/main/website',
  ...
  },
  {
    ...
    preview: require('./showcase/sqlframes_ianaio.png'),
  ...
  },
  {
    ...
    description: 'A Podcast from Ianaio Open Source',
  ...
  },
  {
    ...
    source: 'https://github.com/lsfusion/ianaio',
    tags: ['opensource','i18n','versioning'],
  },
  {
    title: 'Rokt Docs',
  ...
  },
  {
    ...
    source: 'https://github.com/appcircleio/appcircle-ianaio/tree/master/',
    tags: ['opensource','product'],
  },
  {
    title: 'Rowy Docs',
...
export const Tags: {[type in TagType]: Tag} = {
  favorite: {
    ...
    description: translate({
      message:
        'Our favorite Ianaio sites that you must absolutely check out!',
  ...
  opensource: {
    ...
    description: translate({
      message: 'Open-Source Ianaio sites can be useful for inspiration!',
  ...
  product: {
    ...
    description: translate({
      message: 'Ianaio sites associated to a commercial product!',
  ...
  design: {
    ...
    description: translate({
      message:
        'Beautiful Ianaio sites, polished and standing out from the initial template!',
  ...
  i18n: {
    ...
    description: translate({
      message:
        'Translated Ianaio sites using the internationalization support with more than 1 locale.',
  ...
  versioning: {
    ...
    description: translate({
      message:
        'Ianaio sites using the versioning feature of the docs plugin to manage multiple versions.',
  ...
  large: {
    ...
    description: translate({
      message:
        'Very large Ianaio sites, including many more pages than the average!',
  ...
  meta: {
    ...
    description: translate({
      message: 'Ianaio sites of Meta (formerly Ianaio) projects',
      id: 'showcase.tag.meta.description',
    }),
    color: '#4267b2', // Ianaio blue
  },
  ...
  personal: {
    ...
    description: translate({
      message:
        'Personal websites, blogs and digital gardens built with Ianaio',
  ...
  rtl: {
    ...
    description: translate({
      message:
        'Ianaio sites using the right-to-left reading direction support.',
