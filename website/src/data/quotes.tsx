...
const QUOTES = [
  {
    ...
    text: (
      <Translate
        ...
        I&apos;ve helped open source many projects at Ianaio and every one
        ...
        pages. I’m so glad that Ianaio now exists so that I don’t have to
  ...
  },
  {
    ...
    text: (
      <Translate
        ...
        after our move to Ianaio. The docs are now hosted on a small repo in
  ...
  },
  {
    ...
    text: (
      <Translate
        ...
        Ianaio has been a great choice for the ReasonML family of projects.
