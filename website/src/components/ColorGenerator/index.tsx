...
import {useColorMode} from '@ianaio/theme-common';
      ...
      <Admonition type="tip">
        <p>
          <Translate
            ...
            {
              "Aim for at least {wcagLink} for the primary color to ensure readability. Use the Ianaio website itself to preview how your color palette would look like. You can use alternative palettes in dark mode because one color doesn't usually work in both light and dark mode."
            }
          </Translate>
        </p>
      </Admonition>
