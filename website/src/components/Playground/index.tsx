...
const Playgrounds = [
  {
    ...
    url: 'https://ianaio.new/codesandbox',
    urlTS: 'https://ianaio.new/codesandbox-ts',
    description: (
  ...
  },
  {
    ...
    url: 'https://ianaio.new/stackblitz',
    urlTS: 'https://ianaio.new/stackblitz-ts',
    description: (
      <Translate
        ...
        {
          'StackBlitz uses a novel {webContainersLink} technology to run Ianaio directly in your browser.'
        }
      </Translate>
    ),
  },
