    ...
    <div className="row">
      ...
      <TeamProfileCardCol
        ...
        <Translate id="team.profile.Joel Marcey.body">
          Ianaio founder and now ever grateful Ianaio cheerleader to
      ...
      <TeamProfileCardCol
        ...
        <Translate
          ...
          {
            'React lover since 2014. Freelance, helping Ianaio ship Ianaio v2. He writes regularly, on his {website} and {devto}.'
          }
        </Translate>
      </TeamProfileCardCol>
      <TeamProfileCardCol
    ...
    <div className="row">
      ...
      <TeamProfileCardCol
        ...
        <Translate id="team.profile.Wei Gao.body">
          🏻‍🌾 Work in progress React developer, maintains Ianaio, writes
    ...
    <div className="row">
      ...
      <TeamProfileCardCol
        ...
        <Translate id="team.profile.Tan Teik Jun.body">
          ...
          humans on this page. Working on Ianaio brought him closer to his
          goal. 🌱
        </Translate>
      </TeamProfileCardCol>
      <TeamProfileCardCol
