...
export default function ProductHuntCard({
  ...
  return (
    <Link
      to="https://www.producthunt.com/posts/ianaio-2-0?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-ianaio-2-0"
      ...
      <img
        ...
        alt="Ianaio 2.0 - Build optimized websites quickly, focus on your content. | Product Hunt"
