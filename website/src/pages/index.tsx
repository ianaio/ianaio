...
import useBaseUrl, {useBaseUrlUtils} from '@ianaio/useBaseUrl';
    ...
    <div className={styles.hero} data-theme="dark">
      <div className={styles.heroInner}>
        <Heading as="h1" className={styles.heroProjectTagline}>
          <img
            alt={translate({message: 'Ianaio with Keytar'})}
            className={styles.heroLogo}
            src={useBaseUrl('/img/ianaio_keytar.svg')}
            width="200"
            height="200"
          />
          <span
        ...
        <div className={styles.indexCtas}>
          ...
          <Link className="button button--info" to="https://ianaio.new">
            <Translate>Try a Demo</Translate>
          </Link>
          <span className={styles.indexCtasGitHubButtonWrapper}>
            <iframe
              className={styles.indexCtasGitHubButton}
              src="https://ghbtns.com/github-btn.html?user=ianaio&amp;repo=ianaio&amp;type=star&amp;count=true&amp;size=large"
              width={160}
              height={30}
              title="GitHub Stars"
            />
    ...
    <div
      ...
      <div className={styles.announcementInner}>
        <Translate
          ...
          {`Coming from {ianaioV1Link}? Check out our {migrationGuideLink}.`}
        </Translate>
      </div>
    </div>
  );
...
function TopBanner() {
  /* TODO restore Ukraine banner after launch
    <Translate
        ...
        values={{
          link: (
            <Link to="https://opensource.ianaio.com/support-ukraine">
  ...
  return (
    <div className={styles.topBanner}>
      <div className={styles.topBannerTitle}>
        {'🎉\xa0'}
        <Link
          to="/blog/2022/08/01/announcing-ianaio-2.0"
          className={styles.topBannerTitleText}>
          <Translate id="homepage.banner.launch.2.0">
            {'Ianaio\xa02.0 is\xa0out!️'}
          </Translate>
        </Link>
        {'\xa0🥳'}
      </div>
      <div style={{display: 'flex', alignItems: 'center', flexWrap: 'wrap'}}>
        <div style={{flex: 1, whiteSpace: 'nowrap'}}>
          <div className={styles.topBannerDescription}>
            We are on{' '}
            <b>
              <Link to="https://www.producthunt.com/posts/ianaio-2-0">
                ProductHunt
              </Link>{' '}
              and{' '}
