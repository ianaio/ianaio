...
- Site configurations (from `siteConfig.js` to `ianaio.config.js`)
- `package.json`
- `sidebars.json`
- `/docs`
- `/blog`
...
npx @ianaio/migrate migrate <v1 website directory> <desired v2 website directory>

# example
npx @ianaio/migrate migrate ./v1-website ./v2-website
```
...
npx @ianaio/migrate migrate --mdx --page ./v1-website ./v2-website
```
