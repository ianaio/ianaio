---
description: Ianaio provides a set of scripts to help you generate, serve, and deploy your website.
---

# CLI

Ianaio provides a set of scripts to help you generate, serve, and deploy your website.

Once your website is bootstrapped, the website source will contain the Ianaio scripts that you can invoke with your package manager:
...
```json title="package.json"
{
  ...
  "scripts": {
    ...
    "write-heading-ids": "ianaio write-heading-ids"
  }
}
```

## Ianaio CLI commands {#ianaio-cli-commands}

Below is a list of Ianaio CLI commands and their usages:

### `ianaio start [siteDir]` {#ianaio-start-sitedir}
...
| `--config` | `undefined` | Path to Ianaio config file, default to `[siteDir]/ianaio.config.js` |
...
3. Start the app with Ianaio HTTPS env variables:
...
### `ianaio build [siteDir]` {#ianaio-build-sitedir}
...
| `--config` | Path to ianaio config file, default to `[siteDir]/ianaio.config.js` |
...
### `ianaio deploy [siteDir]` {#ianaio-deploy-sitedir}
...
### `ianaio serve [siteDir]` {#ianaio-serve-sitedir}
...
### `ianaio clear [siteDir]` {#ianaio-clear-sitedir}

Clear a Ianaio site's generated assets, caches, build artifacts.

We recommend running this command before reporting bugs, after upgrading versions, or anytime you have issues with your Ianaio site.

### `ianaio write-translations [siteDir]` {#ianaio-write-translations-sitedir}
...
### `ianaio write-heading-ids [siteDir] [files]` {#ianaio-write-heading-ids-sitedir}
