---
sidebar_position: 3
slug: /api/plugins/@ianaio/plugin-content-pages
---
...
The default pages plugin for Ianaio. The classic template ships with this plugin with default configurations. This plugin provides [creating pages](guides/creating-pages.mdx) functionality.

## Installation {#installation}

```bash npm2yarn
npm install --save @ianaio/plugin-content-pages
```
...
// Plugin Options: @ianaio/plugin-content-pages
...
- **Base path**: `website/i18n/[locale]/ianaio-plugin-content-pages`
- **Multi-instance path**: `website/i18n/[locale]/ianaio-plugin-content-pages-[pluginId]`
- **JSON files**: extracted with [`ianaio write-translations`](../../cli.mdx#ianaio-write-translations-sitedir)
- **Markdown files**: `website/i18n/[locale]/ianaio-plugin-content-pages`

### Example file-system structure {#example-file-system-structure}

```bash
website/i18n/[locale]/ianaio-plugin-content-pages
│
