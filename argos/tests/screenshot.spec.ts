...
// Ianaio adds a <html data-has-hydrated="true">
function waitForIanaioHydration() {
...
function createPathnameTest(pathname: string) {
  test(`pathname ${pathname}`, async ({page}) => {
    ...
    await page.goto(url);
    await page.waitForFunction(waitForIanaioHydration);
...
test.describe('Ianaio site screenshots', () => {
