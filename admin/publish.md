...
Ianaio is published as an npm package that can be installed via `npm` or `yarn`.
...
You need publish access to **the main Ianaio repository** (not a fork).
...
This local test step is optional because it will be run by the CI on your release PR ([see](https://github.com/ianaio/ianaio/pull/2954/checks?check_run_id=780871959))
...
```sh
yarn workspace website ianaio docs:version 2.0.0-beta.0
```
...
Check [Netlify site deployments](https://app.netlify.com/sites/ianaio-2/deploys) to pick a recent immutable deployment URL.
...
Example PR: [#3114](https://github.com/ianaio/ianaio/pull/5098), using title such as `chore: prepare v2.0.0-beta.0 release`
...
<details>
 ...
 <pre>
{
  "@ianaio/plugin-sitemap": "read-write",
  "@ianaio/mdx-loader": "read-write",
  "@ianaio/utils": "read-write",
  "@ianaio/core": "read-write",
  "@ianaio/plugin-content-blog": "read-write",
  "@ianaio/plugin-content-docs": "read-write",
  "@ianaio/plugin-content-pages": "read-write",
  "@ianaio/preset-classic": "read-write",
  "@ianaio/theme-search-algolia": "read-write",
  "@ianaio/theme-classic": "read-write",
  "@ianaio/theme-live-codeblock": "read-write",
  "@ianaio/plugin-google-analytics": "read-write",
  "@ianaio/plugin-google-gtag": "read-write",
  "@ianaio/plugin-content-docs-legacy": "read-write",
  "@ianaio/plugin-ideal-image": "read-write",
  "@ianaio/types": "read-write",
  "create-ianaio": "read-write",
  "ianaio": "read-write",
...
It can happen that some accesses are not granted, as an admin might add you to the @ianaio npm organization, but you don't have access to the packages that are not in that organization.
...
- Go to https://github.com/ianaio/ianaio/releases/new
...
After a release, update the examples to keep them in sync with the latest release. This will ensure that playgrounds are able to use the new version at [ianaio.new](https://ianaio.new).
...
See release notes at the following link https://github.com/ianaio/ianaio/releases/tag/%VER%
```
...
https://github.com/ianaio/ianaio/releases/tag/%VER%
```
