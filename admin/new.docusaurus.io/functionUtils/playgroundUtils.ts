...
const CookieName = 'IanaioPlaygroundName';

const PlaygroundConfigs = {
  codesandbox:
    'https://codesandbox.io/p/sandbox/github/ianaio/ianaio/tree/main/examples/classic?file=%2FREADME.md',
  'codesandbox-ts':
    'https://codesandbox.io/p/sandbox/github/ianaio/ianaio/tree/main/examples/classic-typescript?file=%2FREADME.md',

  // Slow to load
  // stackblitz: 'https://stackblitz.com/github/ianaio/ianaio/tree/main/examples/classic',
  // Dedicated branch: faster load
  stackblitz: 'https://stackblitz.com/github/ianaio/ianaio/tree/starter',
  'stackblitz-ts':
