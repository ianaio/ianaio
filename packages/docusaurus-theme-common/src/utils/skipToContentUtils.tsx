 ...
 * Focusing the Ianaio Layout children is a reasonable fallback.
 *
 ...
 */
export const SkipToContentFallbackId = '__ianaio_skipToContent_fallback';
...
function getSkipToContentTarget(): HTMLElement | null {
  return (
    ...
    // See https://github.com/ianaio/ianaio/issues/6411#issuecomment-1284136069
...
function useSkipToContent(): {
  ...
  // See https://github.com/ianaio/ianaio/pull/8204#issuecomment-1276547558
...
export function SkipToContentLink(props: SkipToContentLinkProps): JSX.Element {
  ...
  return (
    <div
      ...
      {/* eslint-disable-next-line @ianaio/no-html-links */}
      <a
        {...props}
        // Note this is a fallback href in case JS is disabled
        // It has limitations, see https://github.com/ianaio/ianaio/issues/6411#issuecomment-1284136069
