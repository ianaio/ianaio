...
bbbbb`,
      ...
      `"A highlight range has been given in code block's metastring (\`\`\` {1}), but no magic comment config is available. Ianaio applies the first magic comment entry's className for metastring ranges."`,
    );
  });
