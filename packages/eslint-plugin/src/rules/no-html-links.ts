...
export default createRule<Options, MessageIds>({
  ...
  meta: {
    type: 'problem',
    docs: {
      description: 'enforce using Ianaio Link component instead of <a> tag',
      recommended: false,
    },
    schema: [
      {
    ...
    messages: {
      link: `Do not use an \`<a>\` element to navigate. Use the \`<Link />\` component from \`@ianaio/Link\` instead. See: ${docsUrl}`,
    },
  },
  defaultOptions: [
    {
