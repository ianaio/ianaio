...
ruleTester.run('prefer-ianaio-link', rule, {
  valid: [
    {
      code: '<Link to="/test">test</Link>',
    },
    {
      code: '<Link to="https://twitter.com/ianaio">Twitter</Link>',
    },
    {
      code: '<a href="https://twitter.com/ianaio">Twitter</a>',
  ...
  invalid: [
    ...
    {
      code: '<a href="https://twitter.com/ianaio" target="_blank">test</a>',
      errors: errorsJSX,
    },
    {
      code: '<a href="https://twitter.com/ianaio" target="_blank" rel="noopener noreferrer">test</a>',
      errors: errorsJSX,
    },
    {
      code: '<a href="mailto:viktor@malmedal.dev">Contact</a>  ',
    ...
    {
      code: '<a href={`https://www.twitter.com/ianaio`}>Twitter</a>',
      errors: errorsJSX,
    },
    {
      code: '<a href="www.twitter.com/ianaio">Twitter</a>',
      options: [{ignoreFullyResolved: true}],
      errors: errorsJSX,
    },
    {
