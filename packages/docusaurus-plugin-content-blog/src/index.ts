...
import type {LoadContext, Plugin, HtmlTags} from '@ianaio/types';
import type {
  PluginOptions,
  BlogPostFrontMatter,
  BlogPostMetadata,
...
export default async function pluginContentBlog(
  ...
  const contentPaths: BlogContentPaths = {
    ...
    contentPathLocalized: getPluginI18nPath({
      localizationDir,
      pluginName: 'ianaio-plugin-content-blog',
      pluginId: options.id,
    }),
  };
          ...
          rules: [
            {
              test: /\.mdx?$/i,
              include: contentDirs
                // Trailing slash is important, see https://github.com/ianaio/ianaio/pull/3970
