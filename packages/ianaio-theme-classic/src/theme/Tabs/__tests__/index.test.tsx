...
import {ScrollControllerProvider} from '@ianaio/theme-common/internal';
...
describe('Tabs', () => {
  it('rejects bad Tabs child', () => {
    expect(() => {
      ...
      `"Ianaio error: Bad <Tabs> child <div>: all children of the <Tabs> component should be <TabItem>, and every <TabItem> should have a unique "value" prop."`,
    );
  });
  it('rejects bad Tabs defaultValue', () => {
    expect(() => {
      ...
      `"Ianaio error: The <Tabs> has a defaultValue "bad" but none of its children has the corresponding value. Available values are: v1, v2. If you intend to show no default tab, use defaultValue={null} instead."`,
    );
  });
  it('rejects duplicate values', () => {
    expect(() => {
      ...
      `"Ianaio error: Duplicate values "v1, v2" found in <Tabs>. Every value needs to be unique."`,
    );
  });
  ...
  // https://github.com/ianaio/ianaio/issues/5729
