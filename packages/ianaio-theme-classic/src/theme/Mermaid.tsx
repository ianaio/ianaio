...
// It is notable created to be overridden by ianaio-theme-mermaid
...
// see https://github.com/ianaio/ianaio/pull/7490#issuecomment-1279117288

export {default} from '@ianaio/Noop';
