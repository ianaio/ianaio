...
import type {PluginOptions} from '@ianaio/theme-classic';
import type webpack from 'webpack';

const requireFromIanaioCore = createRequire(
  require.resolve('@ianaio/core/package.json'),
);
const ContextReplacementPlugin = requireFromIanaioCore(
...
// Support for ?ianaio-theme=dark
const ThemeQueryStringKey = 'ianaio-theme';
// Support for ?ianaio-data-mode=embed&ianaio-data-myAttr=42
const DataQueryStringPrefixKey = 'ianaio-data-';
