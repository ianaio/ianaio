...
import type {Options, PluginOptions} from '@ianaio/theme-classic';
import type {ThemeConfig} from '@ianaio/theme-common';
import type {Validate} from '@ianaio/types';
    ...
    const userConfig = {
      ...
      footer: {
        ...
        logo: {
          ...
          href: 'https://opensource.ianaio.com',
          target: '_self',
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Ianaio, Inc. Built with Ianaio.`,
      },
      tableOfContents: {
        minHeadingLevel: 2,
        maxHeadingLevel: 5,
      ...
      navbar: {
        items: [
          ...
          // Doc version dropdown
          {
            ...
            dropdownItemsBefore: [
              {
                href: 'https://www.npmjs.com/package/ianaio?activeTab=versions',
