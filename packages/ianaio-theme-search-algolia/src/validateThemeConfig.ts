...
export const Schema = Joi.object<ThemeConfig>({
  algolia: Joi.object({
    ...
    appId: Joi.string().required().messages({
      'any.required':
        '"algolia.appId" is required. If you haven\'t migrated to the new DocSearch infra, please refer to the blog post for instructions: https://iana.io/blog/2021/11/21/algolia-docsearch-migration',
    }),
