...
async function toAssetRequireNode(
  ...
  // MdxJsxTextElement => see https://github.com/ianaio/ianaio/pull/8288#discussion_r1125871405
...
async function processLinkNode(target: Target, context: Context) {
  ...
  if (!node.url) {
    ...
    // see https://github.com/ianaio/ianaio/issues/3309#issuecomment-690371675
    const title =
