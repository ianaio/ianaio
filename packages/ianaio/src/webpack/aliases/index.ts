 ...
 *
 * @see https://github.com/ianaio/ianaio/pull/3922
 * @see https://github.com/ianaio/ianaio/issues/5382
 */
 ...
 * aliases instead.
 */
export async function loadIanaioAliases(): Promise<ThemeAliases> {
