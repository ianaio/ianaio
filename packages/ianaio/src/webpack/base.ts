...
import {md5Hash, getFileLoaderUtils} from '@ianaio/utils';
import {
...
import {loadThemeAliases, loadIanaioAliases} from './aliases';
...
export async function createBaseConfig(
  ...
  return {
    ...
    cache: {
      ...
      buildDependencies: {
        config: [
          ...
          // Ianaio config changes can affect MDX/JSX compilation, so we'd
    ...
    resolve: {
      ...
      symlinks: true, // See https://github.com/ianaio/ianaio/issues/3272
      roots: [
      ...
      splitChunks: isServer
        ...
        : {
            ...
            cacheGroups: {
              ...
              // See https://github.com/ianaio/ianaio/issues/2006
              styles: {
                name: 'styles',
