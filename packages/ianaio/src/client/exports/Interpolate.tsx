...
More details here: https://github.com/ianaio/ianaio/pull/4295
*/
...
export default function Interpolate<Str extends string>({
  ...
  if (typeof children !== 'string') {
    throw new Error(
      `The Ianaio <Interpolate> component only accept simple string values. Received: ${
