...
import {interpolate, type InterpolateValues} from '@ianaio/Interpolate';
...
function getLocalizedMessage({
  ...
  if (typeof id === 'undefined' && typeof message === 'undefined') {
    throw new Error(
      'Ianaio translation declarations must have at least a translation id or a default translation message',
    );
  }
...
export default function Translate<Str extends string>({
  ...
  if (children && typeof children !== 'string') {
    ...
    throw new Error(
      'The Ianaio <Translate> component only accept simple string values',
    );
  }
