...
import {removePrefix, removeSuffix, resolvePathname} from '@ianaio/utils';
...
- On source page path = ${pagePath}:
   ...
   * this out. See https://github.com/ianaio/ianaio/issues/3567#issuecomment-706973805
   */
...
Frequent broken links are linking to:${frequentLinks}`;
  ...
  return `Ianaio found broken links!

Please check the pages of your site in the list below, and make sure you don't reference any path that does not exist.
Note: it's possible to ignore broken links with the 'onBrokenLinks' Ianaio configuration, and let the build pass.${getLayoutBrokenLinksHelpMessage()}
