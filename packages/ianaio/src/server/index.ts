...
import type {IanaioConfig, LoadContext, Props} from '@ianaio/types';
...
export async function loadContext(
  ...
  const siteConfig: IanaioConfig = {...initialSiteConfig, baseUrl};
...
/**
 * This is the crux of the Ianaio server-side. It reads everything it needs—
...
export async function load(options: LoadContextOptions): Promise<Props> {
  ...
  const genWarning = generate(
    ...
    `This folder stores temp files that Ianaio' client bundler accesses.
