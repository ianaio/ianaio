...
import type {UseDataOptions} from '@ianaio/types';
...
// see https://github.com/ianaio/ianaio/issues/5089
const StableEmptyObject = {};

// In blog-only mode, docs hooks are still used by the theme. We need a fail-
// safe fallback when the docs plugin is not in use
export const useAllDocsData = (): {[pluginId: string]: GlobalPluginData} =>
  (useAllPluginInstancesData('ianaio-plugin-content-docs') as
    | {
...
export const useDocsData = (pluginId: string | undefined): GlobalPluginData =>
  usePluginData('ianaio-plugin-content-docs', pluginId, {
    failfast: true,
  }) as GlobalPluginData;

// TODO this feature should be provided by ianaio core
