...
import {getPluginI18nPath, DEFAULT_PLUGIN_ID} from '@ianaio/utils';
import {
  VERSIONS_JSON_FILE,
  VERSIONED_DOCS_DIR,
...
export function getDocsDirPathLocalized({
  ...
  return getPluginI18nPath({
    localizationDir,
    pluginName: 'ianaio-plugin-content-docs',
    pluginId,
    subPaths: [
...
> {
  ...
  // See https://github.com/ianaio/ianaio/issues/3366
  // See https://github.com/ianaio/ianaio/pull/4775
  if (
    versionName === CURRENT_VERSION_NAME &&
