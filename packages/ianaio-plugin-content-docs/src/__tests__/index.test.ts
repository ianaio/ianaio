...
import {applyConfigureWebpack} from '@ianaio/core/src/webpack/utils';
import {sortConfig} from '@ianaio/core/src/server/plugins/routeConfig';
...
import type {RouteConfig, Validate, Plugin} from '@ianaio/types';
import type {
  LoadedVersion,
  Options,
  PluginOptions,
  ...
  it('site with wrong sidebar file path', async () => {
    ...
    await expect(async () => {
      ...
      await plugin.loadContent!();
            ...
            - undefined: for Ianaio to generate it automatically"
          `);
  });
...
describe('site with partial autogenerated sidebars 2 (fix #4638)', () => {
  // Test added for edge case https://github.com/ianaio/ianaio/issues/4638
