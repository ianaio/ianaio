...
import {escapeRegexp} from '@ianaio/utils';
...
export const DEFAULT_CONFIG = {
  ...
  // see also https://github.com/ianaio/ianaio/issues/5880
...
export const Schema = Joi.object<ThemeConfig>({
  algolia: Joi.object({
    ...
    appId: Joi.string().required().messages({
      'any.required':
        '"algolia.appId" is required. If you haven\'t migrated to the new DocSearch infra, please refer to the blog post for instructions: https://ianaio.io/blog/2021/11/21/algolia-docsearch-migration',
    }),
