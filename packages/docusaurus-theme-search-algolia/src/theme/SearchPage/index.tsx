...
import {useAllDocsData} from '@ianaio/plugin-content-docs/client';
import {
...
function SearchPageContent(): JSX.Element {
  ...
  const algoliaHelper = algoliaSearchHelper(algoliaClient, indexName, {
    hitsPerPage: 15,
    advancedSyntax: true,
    disjunctiveFacets: ['language', 'ianaio_tag'],
  });
  ...
  const makeSearch = useEvent((page: number = 0) => {
    algoliaHelper.addDisjunctiveFacetRefinement('ianaio_tag', 'default');
      ...
      <Head>
        ...
        {/*
         We should not index search pages
          See https://github.com/ianaio/ianaio/pull/3233
        */}
