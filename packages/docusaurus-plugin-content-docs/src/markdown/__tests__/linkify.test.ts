...
import type {VersionMetadata} from '@ianaio/plugin-content-docs';
...
const sourceToPermalink: SourceToPermalink = {
  ...
  '@site/i18n/fr/ianaio-plugin-content-docs/current/doc-localized.md':
    '/fr/doc-localized',
...
describe('linkify', () => {
  ...
  it('throws for file outside version', async () => {
    ...
    await expect(() =>
      ...
      `"Unexpected error: Markdown file at "<PROJECT_ROOT>/packages/ianaio-plugin-content-docs/src/markdown/__tests__/__fixtures__/outside/doc1.md" does not belong to any docs version!"`,
    );
  });
});
