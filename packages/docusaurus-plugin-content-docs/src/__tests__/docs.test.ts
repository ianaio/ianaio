...
import {loadContext} from '@ianaio/core/src/server/index';
import {createSlugger, posixPath, DEFAULT_PLUGIN_ID} from '@ianaio/utils';
...
describe('simple site', () => {
  ...
  it('docs with editUrl', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('foo', 'baz.md'), {
      ...
      title: 'baz',
      editUrl:
        'https://github.com/ianaio/ianaio/edit/main/website/docs/foo/baz.md',
      description: 'Images',
      frontMatter: {
        id: 'baz',
        slug: 'bazSlug.html',
...
describe('versioned site', () => {
  ...
  it('versioned docs', async () => {
    ...
    await version100TestUtils.testMeta(path.join('hello.md'), {
      ...
      version: '1.0.0',
      source:
        '@site/i18n/en/ianaio-plugin-content-docs/version-1.0.0/hello.md',
      tags: [],
      unlisted: false,
    });
  ...
  it('translated doc with editUrl', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/en/ianaio-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/ianaio/ianaio/edit/main/website/versioned_docs/version-1.0.0/hello.md',
      tags: [],
      unlisted: false,
    });
  });
  ...
  it('translated en doc with editUrl and editCurrentVersion=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/en/ianaio-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/ianaio/ianaio/edit/main/website/docs/hello.md',
      tags: [],
      unlisted: false,
    });
  });
  ...
  it('translated fr doc with editUrl and editLocalizedFiles=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      version: '1.0.0',
      source:
        '@site/i18n/fr/ianaio-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/ianaio/ianaio/edit/main/website/i18n/fr/ianaio-plugin-content-docs/version-1.0.0/hello.md',
      tags: [],
      unlisted: false,
    });
  });
  ...
  it('translated fr doc with editUrl and editLocalizedFiles=true + editCurrentVersion=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/fr/ianaio-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/ianaio/ianaio/edit/main/website/i18n/fr/ianaio-plugin-content-docs/current/hello.md',
      tags: [],
      unlisted: false,
    });
  });
