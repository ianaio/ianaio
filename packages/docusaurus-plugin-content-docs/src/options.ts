...
import type {PluginOptions, Options} from '@ianaio/plugin-content-docs';
...
const OptionsSchema = Joi.object<PluginOptions>({
  ...
  homePageId: Joi.any().forbidden().messages({
    'any.unknown':
      'The docs plugin option homePageId is not supported anymore. To make a doc the "home", please add "slug: /" in its front matter. See: https://ianaio.io/docs/next/docs-introduction#home-page-docs',
  }),
