...
import {DEFAULT_PLUGIN_ID} from '@ianaio/utils';
import {readVersionsMetadata} from '../index';
import {DEFAULT_OPTIONS} from '../../options';
import type {I18n, LoadContext} from '@ianaio/types';
import type {
  PluginOptions,
  VersionMetadata,
} from '@ianaio/plugin-content-docs';
    ...
    async function loadSite() {
      ...
      const vCurrent: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          simpleSiteDir,
          'i18n/en/ianaio-plugin-content-docs/current',
        ),
        isLast: true,
        routePriority: -1,
  ...
  describe('versioned site, pluginId=default', () => {
    async function loadSite() {
      ...
      const v101: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/ianaio-plugin-content-docs/version-1.0.1',
        ),
        isLast: true,
        routePriority: -1,
      ...
      const v100: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/ianaio-plugin-content-docs/version-1.0.0',
        ),
        isLast: false,
        routePriority: undefined,
        sidebarFilePath: path.join(
      ...
      const vWithSlugs: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/ianaio-plugin-content-docs/version-withSlugs',
        ),
        isLast: false,
        routePriority: undefined,
        sidebarFilePath: path.join(
      ...
      expect(versionsMetadata).toEqual([
        {
          ...vCurrent,
          editUrl:
            'https://github.com/ianaio/ianaio/edit/main/website/docs',
          editUrlLocalized:
            'https://github.com/ianaio/ianaio/edit/main/website/i18n/en/ianaio-plugin-content-docs/current',
        },
        {
          ...v101,
          editUrl:
            'https://github.com/ianaio/ianaio/edit/main/website/versioned_docs/version-1.0.1',
          editUrlLocalized:
            'https://github.com/ianaio/ianaio/edit/main/website/i18n/en/ianaio-plugin-content-docs/version-1.0.1',
        },
        {
          ...v100,
          editUrl:
            'https://github.com/ianaio/ianaio/edit/main/website/versioned_docs/version-1.0.0',
          editUrlLocalized:
            'https://github.com/ianaio/ianaio/edit/main/website/i18n/en/ianaio-plugin-content-docs/version-1.0.0',
        },
        {
          ...vWithSlugs,
          editUrl:
            'https://github.com/ianaio/ianaio/edit/main/website/versioned_docs/version-withSlugs',
          editUrlLocalized:
            'https://github.com/ianaio/ianaio/edit/main/website/i18n/en/ianaio-plugin-content-docs/version-withSlugs',
        },
      ]);
    });
  ...
  describe('versioned site, pluginId=community', () => {
    async function loadSite() {
      ...
      const vCurrent: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/ianaio-plugin-content-docs-community/current',
        ),
        isLast: false,
        routePriority: undefined,
        sidebarFilePath: path.join(versionedSiteDir, 'sidebars.json'),
      ...
      const v100: VersionMetadata = {
        ...
        contentPathLocalized: path.join(
          versionedSiteDir,
          'i18n/en/ianaio-plugin-content-docs-community/version-1.0.0',
        ),
        isLast: true,
        routePriority: -1,
        sidebarFilePath: path.join(
