...
import {updateTranslationFileMessages} from '@ianaio/utils';
    ...
    links: [
      {
        ...
        items: [
          {label: 'Link 1', to: 'https://ianaio.com'},
          {label: 'Link 2', to: 'https://ianaio.com'},
        ],
      },
      {
        title: 'Footer link column 2',
        items: [{label: 'Link 3', to: 'https://ianaio.com'}],
      },
    ],
  },
...
describe('getTranslationFiles and translateThemeConfig isomorphism', () => {
  ...
  // See https://github.com/ianaio/ianaio/issues/3936
