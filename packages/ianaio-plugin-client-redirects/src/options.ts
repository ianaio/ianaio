...
import {Joi, PathnameSchema} from '@ianaio/utils-validation';
import type {OptionValidationContext} from '@ianaio/types';

export type RedirectOption = {
  /** Pathname of an existing Ianaio page */
  to: string;
...
export type PluginOptions = {
  ...
  /**
   * A callback to create a redirect rule. Ianaio query this callback
