...
import {BABEL_CONFIG_FILE_NAME} from '@ianaio/utils';
...
export function getStyleLoaders(
  ...
  const cssOptions: {[key: string]: unknown} = {
    // TODO turn esModule on later, see https://github.com/ianaio/ianaio/pull/6424
    esModule: false,
    ...cssOptionsArg,
  };
    ...
    },
    {
      ...
      options: {
        postcssOptions: {
          ...
          // https://github.com/ianaio/create-react-app/issues/2677
          ident: 'postcss',
          plugins: [
    ...
    new TerserPlugin({
      ...
      terserOptions: {
        parse: {
          ...
          // https://github.com/ianaio/create-react-app/pull/4234
          ecma: 2020,
        },
        compress: {
          ecma: 5,
        ...
        output: {
          ...
          // default. See https://github.com/ianaio/create-react-app/issues/2488
          ascii_only: true,
        },
      },
    }),
