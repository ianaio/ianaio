...
import type {Props} from '@ianaio/Link';
...
function Link(
  ...
  // see https://github.com/ianaio/ianaio/issues/3309
  ...
  return isRegularHtmlLink ? (
    // eslint-disable-next-line jsx-a11y/anchor-has-content, @ianaio/no-html-links
    <a
      ref={innerRef}
      href={targetLink}
