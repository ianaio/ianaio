...
import {normalizeUrl, readOutputHTMLFile} from '@ianaio/utils';
import {blogPostContainerID} from '@ianaio/utils-common';
...
async function defaultCreateFeedItems({
  ...
  return Promise.all(
    blogPosts.map(async (post) => {
      ...
      // See https://github.com/ianaio/ianaio/issues/9136
