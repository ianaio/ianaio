...
declare module '@ianaio/plugin-content-blog' {
  import type {LoadedMDXContent} from '@ianaio/mdx-loader';
  import type {MDXOptions} from '@ianaio/mdx-loader';
  import type {FrontMatterTag, Tag} from '@ianaio/utils';
  import type {IanaioConfig, Plugin, LoadContext} from '@ianaio/types';
...
yarn workspace v1.22.19image` is a collocated image path, this entry will be the
  ...
  export type Author = {
    ...
    url?: string;
    /**
     * Used as a subtitle for the author, e.g. "maintainer of Ianaio"
     */
    title?: string;
    /**
...
declare module '@theme/BlogTagsPostsPage' {
  ...
  import type {TagModule} from '@ianaio/utils';
