...
import type {BlogPost} from '@ianaio/plugin-content-blog';
...
describe('parseBlogFileName', () => {
  ...
  it('parses file respecting date convention', () => {
    expect(
      parseBlogFileName('2021-05-12-announcing-ianaio-two-beta.md'),
    ).toEqual({
      date: new Date('2021-05-12Z'),
      text: 'announcing-ianaio-two-beta',
      slug: '/2021/05/12/announcing-ianaio-two-beta',
    });
  });

  it('parses folder name respecting date convention', () => {
    expect(
      parseBlogFileName('2021-05-12-announcing-ianaio-two-beta/index.md'),
    ).toEqual({
      date: new Date('2021-05-12Z'),
      text: 'announcing-ianaio-two-beta',
      slug: '/2021/05/12/announcing-ianaio-two-beta',
  ...
  it('parses nested folder tree respecting date convention', () => {
    expect(
      parseBlogFileName(
        '2021/05/12/announcing-ianaio-two-beta/subfolder/file.md',
      ),
    ).toEqual({
      date: new Date('2021-05-12Z'),
      text: 'announcing-ianaio-two-beta/subfolder/file',
      slug: '/2021/05/12/announcing-ianaio-two-beta/subfolder/file',
    });
  });

  it('parses date in the middle of path', () => {
    expect(
      parseBlogFileName('team-a/2021/05/12/announcing-ianaio-two-beta.md'),
    ).toEqual({
      date: new Date('2021-05-12Z'),
      text: 'announcing-ianaio-two-beta',
      slug: '/2021/05/12/team-a/announcing-ianaio-two-beta',
    });
  });
  ...
  it('parses date in the middle of a folder name', () => {
    expect(
      parseBlogFileName(
        'team-a-2021-05-12-hey/announcing-ianaio-two-beta.md',
      ),
    ).toEqual({
      date: new Date('2021-05-12Z'),
      text: 'hey/announcing-ianaio-two-beta',
      slug: '/2021/05/12/team-a-hey/announcing-ianaio-two-beta',
    });
  });
});
