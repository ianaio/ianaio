...
import type {BlogPostFrontMatter} from '@ianaio/plugin-content-blog';
...
describe('validateBlogPostFrontMatter slug', () => {
  testField({
    ...
    validFrontMatters: [
      ...
      {slug: '../blog'},
      {slug: '../../blog'},
      {slug: '/api/plugins/@ianaio/plugin-debug'},
...
describe('validateBlogPostFrontMatter image', () => {
  testField({
    ...
    validFrontMatters: [
      ...
      {image: '../blog'},
      {image: '../../blog'},
      {image: '/api/plugins/@ianaio/plugin-debug'},
...
describe('validateBlogPostFrontMatter tags', () => {
  testField({
    ...
    // See https://github.com/ianaio/ianaio/issues/4642
    convertibleFrontMatter: [
      [{tags: [42]}, {tags: ['42']}],
      [
