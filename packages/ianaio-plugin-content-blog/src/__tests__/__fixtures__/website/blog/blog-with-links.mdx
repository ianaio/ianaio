...
[absolute full url](https://github.com/ianaio/ianaio)
...
![](https://ianaio.io/assets/images/slash-introducing-411a16dd05086935b8e9ddae38ae9b45.svg)

<img
  srcSet={`${useBaseUrl('/img/test-image.png 300w')},    ${useBaseUrl(
    '/img/ianaio-social-card.png 500w',
  )}`}
/>
