...
describe('readOutputHTMLFile', () => {
  ...
  it('throws if file does not exist', async () => {
    await expect(
      ...
      `"Expected output HTML file to be found at <PROJECT_ROOT>/packages/ianaio-utils/src/__tests__/__fixtures__/build-snap/nonExistent/index.html for permalink /nonExistent."`,
    );
  });
});
